...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className='mb-14 flex min-h-[200vh] flex-shrink-0 scale-[0.5] transform flex-col items-center justify-start py-0 [perspective:800px]  sm:scale-50 md:scale-125 md:py-80'
    >
      <motion.h2
        style={{
