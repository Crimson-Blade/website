...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className='mb-14 flex min-h-[120vh] flex-shrink-0 scale-[0.65] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50  md:min-h-[200vh] md:scale-125 md:py-80'
    >
      <motion.h2
        style={{
  ...
  return (
    <div className='relative [perspective:800px]'>
      ...
      <motion.div
        ...
        className='absolute inset-0 h-[270px] w-[32rem] rounded-2xl bg-[#010101] p-2'
      >
        <div className='absolute inset-0  h-full w-full rounded-lg bg-[#272729]' />
        <Image
          src={src as string}
          alt='aceternity logo'
          fill
