      ...
      <div className={styles.gridmain}>
        ...
        <div className={styles.gridsub}>
          ...
          >
            <div className='grid-one-sub1 relative flex-1'>
              <Image
                ...
                fill
                objectFit='contain' // Ensures image scales correctly and doesn't overflow
                className='absolute inset-0 hidden pt-6 sm:block'
              />
              <Image
            ...
            <div className='grid-one-sub2 flex items-center justify-center px-6 py-2 text-xl text-white sm:text-2xl lg:py-6'>
          ...
          >
            ...
            <div className='grid-two-sub1 flex items-center justify-center px-6 py-2 text-xl text-white sm:text-2xl lg:py-6'>
