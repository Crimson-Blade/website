      ...
      <div className={styles.gridmain}>
        ...
        <div className={styles.gridsub}>
          <div className={cn(styles.gridone, "flex flex-col rounded-3xl border-2 border-gray-500")}>
            <div className='grid-one-sub1 relative flex-1'>
              <Image
                ...
                fill
                objectFit="contain"  // Ensures image scales correctly and doesn't overflow
                className="absolute inset-0 pt-6 hidden sm:block"
              />
              <Image
                src="/images/ams1-mobile.svg"
                alt="Description of Image"
                fill
                objectFit="contain"  // Ensures image scales correctly and doesn't overflow
                className="absolute inset-0 pt-6 sm:hidden"
              />
            </div>
            <div className="grid-one-sub2 px-6 py-2 lg:py-6 text-xl sm:text-2xl text-white flex justify-center items-center">
          ...
          <div className={cn(styles.gridtwo, "flex flex-col rounded-3xl border-2 border-gray-500")}>
            ...
            <div className="grid-two-sub1 px-6 py-2 lg:py-6 text-xl sm:text-2xl text-white flex justify-center items-center">
